...
Правильная команда для пользователя "2": ps -U 2 >user_2_ps

<img src = "img/user2.png" width = 100%>

Правильная команда для пользователя "5": ps -U 5 >user_5_ps

<img src = "img/user5.png" width = 100%>

Данные отличаются потому, что это разные пользователи. На момент выполнения команды, процессы запущенние этими пользователями могут существенно отличаться. Если один пользователь активно использует систему, а другой нет, то соответственно вывод будет различаться. 
